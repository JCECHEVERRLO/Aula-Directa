...
exports.createUser = async (req, res) => {
  ...
  try {
    ...
    console.log('Nuevo usuario creado con rol:', role); // 👈 verifica que el rol llega correctamente

    if (role === 'parent') {
      console.log('Creando en tabla parents...'); // 👈
      await Parent.create({ user_id: newUser.id });
    } else if (role === 'teacher') {
      console.log('Creando en tabla teachers...'); // 👈
